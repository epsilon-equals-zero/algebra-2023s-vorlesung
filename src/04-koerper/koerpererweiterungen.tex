...
\begin{definition}
    ...
    \begin{itemize}
        ...
        \item Wir nennen $E$ \emph{rein transzendent über $K$}\index{transzendent!rein}, wenn es eine algebraisch unabhängige Teilmenge $S \subseteq E$ gibt mit $E = K(S)$.
