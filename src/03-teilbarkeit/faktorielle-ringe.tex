...
\begin{definition}
    Sei $R$ ein Integritätsbereich, so heißt $R$ \emph{faktorieller Ring}\index{faktorieller Ring} (oder \emph{Gaußscher Ring}\index{Gaußscher Ring}, oder auch \emph{ZPE-Ring}\index{ZPE-Ring}) genau dann wenn
