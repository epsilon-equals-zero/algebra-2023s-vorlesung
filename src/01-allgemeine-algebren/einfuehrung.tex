...
\begin{example}
    ...
    $(\Aut(\mathfrak{A}), \circ, \id_A, {}^{-1})$ ist eine Gruppe, die \emph{Automorphismengruppe von $\mathfrak{A}$}\index{Automorphismengruppe}. Eine Folgerung von \cref{satz:darstellungssatz-cayley-gruppen} ist, dass jede endliche Gruppe isomorph zu einer Automorphismengruppe ist.
\end{example}
