...
\begin{definition}
    Ein kommutativer Ring mit 1 $\mathfrak{A} = (A,+,0,-,\cdot)$ heißt \emph{Körper}\index{Körper}, wenn 
    \begin{itemize}[topsep=0pt, label={--}]
...
\begin{definition}
    Eine Algebra $\mathfrak{A} = (A, \wedge, \vee)$ vom Typ $\tau = (2, 2)$ heißt \emph{Verband}\index{Verband} (im algebraischen Sinn), wenn
    \begin{itemize}[topsep=0pt, label={--}]
