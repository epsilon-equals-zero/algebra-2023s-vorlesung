...
\begin{remark}
    Für eine endliche Indexmenge $I = \{1, \ldots, m\}$ wird der Typ auch als $m$-Tupel $\tau = (n_i, \ldots, n_m)$ geschrieben und die Algebra als $\mathfrak{A} = (A, f_1, \ldots, f_n)$.
\end{remark}
...
\begin{definition}
    ...
    \begin{itemize}[topsep=0pt, label={--}]
        \item $(A, \wedge)$ ein Halbverband,
        \item $(A, \vee)$ ein Halbverband ist, 
...
\begin{example}
    ...
    \begin{minipage}{0.78\textwidth}
        Betrachtet man die Abbildung rechts und definiert eine Ordnungsrelation, wobei eine jeweils die höher stehenden Elemente größer als die niedrigeren sind und sei $\wedge, \vee$ das Maximum bzw. Minimum zweier Elemente. Es ist dann $(\{0,1,2,3,4\}, \wedge, \vee)$ ein nicht distributiver Verband, da
