...
\begin{example}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \draw[orange, rotate=33] (p2) ellipse (0.5 and 0.2);

            \node[circle,fill,inner sep=1pt] (p4) at (-1.8, 0){};

            \draw[->, orange] (-1.01, 0.66) -- node[above, near end] {\scriptsize $f_i$} (p4);

            \node[circle,fill,inner sep=1pt] (p5) at (-1.3, 0){};
            \node[circle,fill,inner sep=1pt] (p6) at (-1.1, 0){};

            \draw[blue] (-1.45,0) ellipse (0.5 and 0.2);

            \node[circle,fill,inner sep=1pt] (p7) at (-1.45, -1.6){};

            \draw[->, blue] (-1.45, -0.2) -- node[left, near end] {\scriptsize $f_j$} (p7);
...
\begin{example}
    Folgende Abbildung visualisiert die Bildung einer Produktalgebra.

    \begin{figure}[H]
        \centering
        \begin{tikzpicture}
            
            \draw[blue] (0, 1.8) -- (8, 1.8) node[right, circle,fill, inner sep=1pt, label=right:$a \in \mathfrak{A}$] (a) {};
            \draw[blue] (0, 1) -- (8, 1) node[right, circle,fill, inner sep=1pt, label=right:$b \in \mathfrak{A}$] (b) {};
            \draw[blue] (0, 0.2) -- (8, 0.2) node[right, circle,fill, inner sep=1pt, label=right:$c \in \mathfrak{A}$] (c) {};
            \draw[teal] (0, -1.3) -- (8, -1.3) node[right, circle,fill, inner sep=1pt, label=right:$d \in \mathfrak{A}$] (d) {};
            ...
            \draw[->, orange] (a1) edge [bend right=45] (d1);
            \draw[->, orange] (b1) edge [bend right=45] (d1);
            \draw[->, orange] (c1) edge [bend right=45] node[left, near end] {$f_i^{\mathfrak{A}_1}$} (d1);

            \draw[->, orange] (a2) edge [bend right=45] (d2);
            \draw[->, orange] (b2) edge [bend right=45] (d2);
            \draw[->, orange] (c2) edge [bend right=45] node[left, near end] {$f_i^{\mathfrak{A}_2}$} (d2);

            \draw[->, orange] (a3) edge [bend right=45] (d3);
            \draw[->, orange] (b3) edge [bend right=45] (d3);
            \draw[->, orange] (c3) edge [bend right=45] node[left, near end] {$f_i^{\mathfrak{A}_3}$} (d3);

            \draw[->, orange] (a) edge [bend right=45] (d);
            \draw[->, orange] (b) edge [bend right=45] (d);
            \draw[->, orange] (c) edge [bend right=45] node[left, near end] {$f_i^{\mathfrak{A}}$} (d);
        \end{tikzpicture}
...
\begin{definition}
    Eine Algebra $\mathfrak{A}$ heißt \emph{einfach}\index{einfache Algebra}\index{allgemeine Algebra!einfach}, wenn es keine nicht-trivialen Kongruenzrelationen gibt.
\end{definition}
...
\begin{remark}
    Sei $\mathfrak{A}$ eine beliebige Faktoralgebra und $\sim$ eine Kongruenzrelation. Dann ist die \emph{kanonische Faktorabbildung}\index{kanonische Faktorabbildung}
