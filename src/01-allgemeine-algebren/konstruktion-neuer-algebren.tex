...
\begin{proof} In beiden Behauptungen wird die gegenseitige Inklusion von zwei Mengen gezeigt.
    \begin{enumerate}
        ...
        $a_1,\ldots,a_{n_i}\in S_{k}$, sodass $a=f^{\mathfrak{A}}(a_1,\ldots,a_{n_i})$. Auch hier kann die Induktionsvoraussetzung
        ...
        von $\mathfrak{A}$ ist, gilt auch $a=f^{\mathfrak{A}}(a_1\ldots,a_{n_i})\in\langle S\rangle$. Daraus folgt die gewünschte Mengeninklusion
