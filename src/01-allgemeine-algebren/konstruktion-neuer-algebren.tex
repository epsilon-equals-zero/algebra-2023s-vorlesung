...
\begin{definition}\label{definition:unterstruktur}
    ...
    \end{itemize}
    Wir schreiben in diesem Fall $\mathfrak{S}\le \mathfrak{A}$. Ist $\mathcal{A}$ eine Gruppe (ein Monoid, ein Ring,...) so nennen wir $\mathcal{S}$ auch \emph{Unterring} (\emph{Untermonoid}, \emph{Unterring},...).
\end{definition}
