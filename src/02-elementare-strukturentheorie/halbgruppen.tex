...
\begin{definition}
    ...
    \end{itemize}
    Ist $a'$ links- und rechtsinvers zu $a$ so nennt man $a'$ \emph{invers}\index{invers} zu $a$ und $a$ heißt \emph{Einheit}\index{Einheit}.
\end{definition}
...
\begin{corollary}
    $(\mathbb{N}\setminus\{0\}, \mid)$ ist eine Halbordnung und induziert einen Verband.
\end{corollary}
