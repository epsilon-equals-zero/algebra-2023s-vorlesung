...
\begin{remark}
    ...
    Ist der Generator (die Variablenmenge) $X$ unendlich, so ist das erzeugte Monoid \emph{total frei}\index{Monoid!total frei} über $X$, das heißt es gelten genau die Gesetze, die in der Varietät gelten.
\end{remark}
