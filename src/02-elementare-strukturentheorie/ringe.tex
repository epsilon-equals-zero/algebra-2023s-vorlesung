...
\begin{definition}
    ...
    $(R\times R^*)/_\sim$ aus Satz \ref{theorem:Quotientenkoerper} \emph{Quotientenk\"orper von $R$}\index{Quotientenkörper} genannt.
...
\begin{theorem}[Chinesischer Restsatz, allgmeien]\index{Chinesischer Restsatz!allgemein}
