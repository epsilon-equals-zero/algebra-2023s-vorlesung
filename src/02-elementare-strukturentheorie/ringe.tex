...
\begin{proof}
    ...
    Daher existieren $\bar{\varphi}:L\to K$ mit $\bar{\varphi}\circ \varphi_0=\varphi$ und $\bar{\varphi_0}:K\to L$ mit $\bar{\varphi_0}\circ \varphi=\varphi_0$. Wir zeigen zuerst die folgende Behauptung. Für jeden injektiven Homomorphismus
